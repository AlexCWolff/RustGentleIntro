...
// If there were semicolons after these string literals then the returned value would be '()', like 'Nothing' or 'void'. It's a common error when defining functions.
fn sqr(x: f64) -> f64 {
    x * x;
}
